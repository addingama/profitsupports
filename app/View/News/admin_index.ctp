...
<div class="spacer clear"></div>
<div class="row">
	<h4 class="twelve title-orange"><?php echo $this->Html->image('news.png', array('class'=>'admin-logo')); ?>News List <?php echo $this->Html->link('Tambah',array('action'=>'add', 'admin'=> true), array('class'=>'button radius'));?></h4>
