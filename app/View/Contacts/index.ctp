...
<div class="spacer twelve clear"></div>
<div class="row">
<?php echo $this->Form->create('Contact', array('class'=>'seven columns block-grid')); ?>
...
?>
	<?php echo $this->Html->image('message.png', array('class'=>'form-logo')); ?>
	<div class="spacer"></div>
	</fieldset>
<?php echo $this->Form->end(); ?>
	<article class="five columns">
		<h4 class="title-orange"><?php echo $this->Html->image('article.png', array('class'=>'content-logo')); ?>Catatan Buat Anda</h4>
		<p class="border-gray">
