...
/*		array (
	...
	$cfg['ilibs'] = array (																// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions	
		array (																		
			'value'   	=> '/app/webroot/img/tutorial',												
			'text'    	=> 'Tutorial Pictures',
		),
		array (																		
			'value'   	=> '/app/webroot/img/news',												
			'text'    	=> 'News Pictures',
		),
		array (																		
			'value'   	=> '/app/webroot/img/gallery',												
			'text'    	=> 'Gallery Pictures',
		),
		array(
	...
	$cfg['ilibs_dir'] 	   = array('/app/webroot/img/upload', '/app/webroot/img/gallery' );						   	// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
